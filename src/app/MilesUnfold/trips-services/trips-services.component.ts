...
export class TripsServicesComponent implements OnInit {
  ...
  trips = [
    ...
    },
    {
      ...
      description: 'Dive into a world of excitement and learning at Ramoji Film City, the world’s largest integrated film city. This tour mixes education with entertainment by providing insight into movie-making techniques and offering numerous fun activities.',
    ...
    },
    {
      ...
      description: 'Discover the marvel of engineering and human accomplishment at Nagarjuna Sagar, the world’s tallest masonry dam. This trip combines learning experience about the dam and its surrounding ecology while also exposing students to local history and culture.',
    ...
    },
    {
      ...
      activities: 'Guided zoo tour, animal feeding experiences, interactive discussions about wildlife conservation, visit to the zoos aquarium and butterfly house.',
      groupSize: 'Itinerary details for Trip 1.',
      duration: 'Itinerary details for Trip 1.',
      ageGroup: 'Age group recommendation for Trip 1.',
    ...
    },
    {
      ...
      activities: 'Exploration of the park, rides, team games, bonding activities.',
      groupSize: 'Itinerary details for Trip 1.',
      duration: 'Itinerary details for Trip 1.',
      ageGroup: 'Age group recommendation for Trip 1.',
